...
$(document).ready(function () {
	...
	$('body').on('click','[data-popup]',function(e) { //Вызов попапов
		...
		setTimeout(function() {
			var input = $('input[name=search-inp]');
			console.log(input);
			input.focus();
		}, 100)
    });
	...
	$('.hmenu').click(function() {
		$('.hmenu-c').toggleClass('active');
	})

	$('.more-btn').click(function() {
		$('.itadd').addClass('active')
		$('.more').addClass('dnon')
	})
	$('.more1-btn').click(function() {
		$('.itadd1').addClass('active')
		$('.more1').addClass('dnon')
	})
	...
	$(".type table").wrap("<div class='tbl'></div>")
})
